...
if (isset($_POST['delete'])) {
    ...
    $cekAktif=$conn->prepare("SELECT COUNT(*) FROM transaksi WHERE id_buku=? AND status_transaksi IN ('Peminjaman','Dipinjam')");
...
$cssVer=@filemtime('../assets/css/petugas/buku.css')?:time();
?>
<!DOCTYPE html>
<html lang="id">
<head>
...
<link rel="stylesheet" href="../assets/css/petugas/buku.css?v=<?= $cssVer ?>">
